...
//        targetUri = new URI("coap://localhost:" + testEndpoint.getPort() + requestPath);
...
//        //testEndpoint.addMessageToOutgoingQueue(new MessageReceiverResponse(emptyACK, true, false));
//
